...
-- ----------------------------
-- Table structure for t_ds_dqs_result
-- ----------------------------
DROP TABLE IF EXISTS `t_ds_dqs_result`;
CREATE TABLE `t_ds_dqs_result` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `task_id` bigint(20) DEFAULT NULL COMMENT 'task id',
  `task_instance_id` bigint(20) DEFAULT NULL COMMENT 'task instance id',
  ...
  `update_time` datetime DEFAULT NULL COMMENT 'update time',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='rule calculate result'

-- ----------------------------
-- Table structure for t_ds_dqs_rule
-- ----------------------------
DROP TABLE IF EXISTS `t_ds_dqs_rule`;
CREATE TABLE `t_ds_dqs_rule` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `name` varchar(100) DEFAULT NULL COMMENT 'rule name',
  `type` int(11) DEFAULT NULL COMMENT 'rule type',
  `rule_json` text COMMENT 'rule json info',
  `create_time` datetime DEFAULT NULL COMMENT 'create time',
  `update_time` datetime DEFAULT NULL COMMENT 'update_time',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='rule info'