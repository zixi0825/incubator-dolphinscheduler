...
import org.apache.dolphinscheduler.dqs.enums.ConnectorType;
    ...
    private IConnector getConnector(SparkSession sparkSession,ConnectorParameter connectorParameter) throws Exception{
        ...
        if(connectorType != null){
            switch (connectorType){
                case HIVE:
                    return new HiveBatchConnector(sparkSession, connectorParameter);
                case JDBC:
                    return new JDBCBatchConnector(sparkSession, connectorParameter);
                default:
